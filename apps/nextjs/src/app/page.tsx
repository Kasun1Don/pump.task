    ...
    <HydrateClient>
      <main className="bg-custom-bg flex h-screen w-screen items-center justify-center bg-cover bg-center py-16 text-center">
        <div className="flex max-w-5xl flex-col items-center justify-center gap-4">
          ...
          <div className="bg-zesty-green text-zesty-green mb-2 rounded-full bg-opacity-10 p-3">
            Web3 Project Management Stack
          </div>
          <p className="text-7xl font-extrabold">
            Keep your project on track & get rewarded
          </p>
          <div className="mb-3 max-w-3xl">
            <p className="text-lg text-gray-400">
              Pump.Task is designed to revolutionise the way teams manage and
              complete their tasks, combining the traditional efficiency of
              tools like Jira and Trello with the rewarding nature of Web3.
            </p>
          </div>
